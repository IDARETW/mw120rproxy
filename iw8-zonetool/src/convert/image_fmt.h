...
inline uint32_t iw3_to_iw8_pixel_format(int32_t iw3Format) {
    switch (iw3Format) {
    case IWI_DXT1:
        return IW8_FMT_BC1_UNORM;
    case IWI_DXT3:
        return IW8_FMT_BC2_UNORM;
    case IWI_DXT5:
        return IW8_FMT_BC3_UNORM;
    case IWI_ARGB32:
        return IW8_FMT_R8G8B8A8_UNORM;
    case IWI_RGB24:
        return IW8_FMT_R8G8B8A8_UNORM; // 24bpp has no direct GPU format -> treat as 32
    case IWI_GA16:
        return IW8_FMT_R8G8B8A8_UNORM;
    case IWI_A8:
        return IW8_FMT_R8G8B8A8_UNORM;
