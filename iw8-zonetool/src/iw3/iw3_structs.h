...
template <typename T> struct iw3_ptr {
...
struct XSurfaceCollisionTree {
    ...
    float scale[3];
    uint32_t nodeCount;
    iw3_ptr<XSurfaceCollisionNode> nodes;
    uint32_t leafCount;
    iw3_ptr<XSurfaceCollisionLeaf> leafs;
};
...
struct XModelStreamInfo {
    iw3_ptr<XModelHighMipBounds> highMipBounds;
};
...
struct XModelCollSurf_s {
    iw3_ptr<XModelCollTri_s> collTris;
    int numCollTris;
    float mins[3];
    float maxs[3];
    int boneIdx;
...
struct PhysGeomList {
    uint32_t count;
    iw3_ptr<void> geoms; /*PhysGeomInfo* */
    float mass[15];
};
...
struct MapTriggers {
    uint32_t count;
    iw3_ptr<TriggerModel> models;
    uint32_t hullCount;
    iw3_ptr<TriggerHull> hulls;
    uint32_t slabCount;
    iw3_ptr<TriggerSlab> slabs;
};
struct GfxPlacement {
    float quat[4];
    float origin[3];
...
struct DynEntityDef {
    ...
    iw3_ptr<void> destroyFx;
    iw3_ptr<void> destroyPieces;
    iw3_ptr<PhysPreset> physPreset;
    int health;
    float mass[9];
    int contents; // PhysMass inlined (9 floats)
};
struct MapEnts {
    iw3_ptr<char> name;
...
struct clipMap_t {
    ...
    iw3_ptr<void> staticModelList;
    uint32_t numMaterials;
    iw3_ptr<void> materials;
    uint32_t numBrushSides;
    iw3_ptr<void> brushsides;
    uint32_t numBrushEdges;
    iw3_ptr<void> brushEdges;
    uint32_t numNodes;
    iw3_ptr<void> nodes;
    uint32_t numLeafs;
    iw3_ptr<void> leafs;
    uint32_t leafbrushNodesCount;
    iw3_ptr<void> leafbrushNodes;
    uint32_t numLeafBrushes;
    iw3_ptr<void> leafbrushes;
    uint32_t numLeafSurfaces;
    iw3_ptr<void> leafsurfaces;
    uint32_t vertCount;
    iw3_ptr<void> verts;
    int triCount;
    iw3_ptr<void> triIndices;
    iw3_ptr<void> triEdgeIsWalkable;
    int borderCount;
    iw3_ptr<void> borders;
    int partitionCount;
    iw3_ptr<void> partitions;
    int aabbTreeCount;
    iw3_ptr<void> aabbTrees;
    uint32_t numSubModels;
    iw3_ptr<cmodel_t> cmodels;
    uint16_t numBrushes;
    iw3_ptr<void> brushes;
    int numClusters;
    int clusterBytes;
    iw3_ptr<char> visibility;
    int vised;
...
struct ComWorld {
    iw3_ptr<char> name;
    int isInUse; /* primaryLights etc. (unwalked) */
};
