...
// marker. Stock 1.20 files have nonzero trailing auth bytes. The converter emits the marker and
// zeros until a live 1.20 test proves the exact trailing-auth rule.
