...
`src/common/json.hpp` is JSON for Modern C++ 3.11.2 by Niels Lohmann and contributors. It is used
under the MIT License. The source file retains its copyright and SPDX license notices.
